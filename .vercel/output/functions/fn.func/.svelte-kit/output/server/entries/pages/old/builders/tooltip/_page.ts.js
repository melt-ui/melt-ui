...
import { c as createTooltip, P as Plus } from "../../../../../chunks/plus.js";
...
const Preview = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button${spread(
    ...
    { classes: "svelte-1ekglum" }
  )}><div${spread([escape_object($arrow)], { classes: "svelte-1ekglum" })}></div> <p class="px-4 py-1 text-magnum-700" data-svelte-h="svelte-1sz6fzr">Add to library</p></div>` : ``}`;
});
const Tailwind = {
  "index.svelte": tw,
