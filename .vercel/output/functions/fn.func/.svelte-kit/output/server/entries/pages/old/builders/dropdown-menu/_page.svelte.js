...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Docs.H1, "Docs.H1").$$render($$result, {}, {}, {
    ...
    default: () => {
      return `Displays a menu to the user, which can consist of links or functions, triggered by a button.`;
    }
    ...
    default: () => {
      return `${validate_component(Docs.Li, "Docs.Li").$$render($$result, {}, {}, {
        default: () => {
          return `<b data-svelte-h="svelte-1igo93q">Trigger:</b> The button which toggles the menu&#39;s open state.`;
        }
