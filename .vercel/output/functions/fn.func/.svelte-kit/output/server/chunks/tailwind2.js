...
import { c as createAvatar } from "./create5.js";
...
const Tailwind = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="flex w-full items-center justify-center gap-6"><div class="flex h-16 w-16 items-center justify-center rounded-full bg-neutral-100"><img${spread(
    [
      escape_object($image),
      { alt: "Avatar" },
