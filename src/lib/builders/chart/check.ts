...

{
	...
	type A = typeof result.dimensions.y.accessor_d;
	const a: A = null!;
	...
	type MergeScaledD = Assert<IsEqual<ReturnType<InferStoreInner<typeof result.dimensions.merge.scaled_d>>, typeof complexReturn>, true>
}
