...
import type {
	CheckboxItemArgs,
	CreateMenuRadioGroupArgs,
	ItemArgs,
	RadioItemActionArgs,
	RadioItemArgs,
	CreateDropdownSubMenuArgs,
} from '../dropdown-menu';
...
export type CreateContextMenuArgs = {
	/**
...
const defaults = {
	...
	preventScroll: true,
} satisfies Defaults<CreateContextMenuArgs>;

export function createContextMenu(args?: CreateContextMenuArgs) {
	const withDefaults = { ...defaults, ...args } as CreateContextMenuArgs;
	 ...
	 */
	function clearTimerStore(timerStore: Writable<number | null>) {
		if (!isBrowser) return;
