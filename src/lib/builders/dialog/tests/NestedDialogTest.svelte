<script lang="ts">
	...
	import Combobox from '$docs/previews/combobox/main/tailwind.svelte';
	import DropdownMenu from '$docs/previews/dropdown-menu/main/tailwind.svelte';
	import Popover from '$docs/previews/popover/main/tailwind.svelte';
	import NestedPopover from '$docs/previews/popover/nested/tailwind.svelte';
	import Select from '$docs/previews/select/main/tailwind.svelte';
...
{#if $open}
	<div melt={$overlay} class="fixed inset-0 z-20 bg-black/50" />
	<div
