...
<Callout>
	To learn more about how the placeholder affects the different parts of the date picker, checkout the placeholders docs for t/he <A href="/docs/builders/date-field">Date Field</A> & <A href="/docsbuilders/calendar">Calendar</A> builders.
</Callout>
