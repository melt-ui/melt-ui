		...
		>
			{#each Object.entries(options) as [key, arr]}
				<div use:melt={$group(key)}>
					...
					{#each arr as item}
						<div
							class="relative cursor-pointer rounded-lg py-1 pl-8 pr-4 text-neutral-800 focus:z-10 data-[highlighted]:bg-magnum-50 data-[selected]:bg-magnum-200 data-[highlighted]:text-magnum-900 data-[selected]:text-magnum-900 data-[disabled]:opacity-50"
