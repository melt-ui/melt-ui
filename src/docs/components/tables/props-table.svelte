				...
				<table class="w-full min-w-[540px] border-b border-neutral-700 text-left sm:min-w-full">
					<tbody class="divide-y divide-neutral-700">
						<tr class="w-1/4 text-neutral-300">
							<td class="w-1/6 whitespace-nowrap py-2 pl-4 text-sm font-medium sm:pl-0"> Prop </td>
							<td class="w-1/6 whitespace-nowrap py-2 text-sm font-medium">Default</td>
							<td class="w-2/3 whitespace-nowrap py-2 text-sm font-medium">Type / Description</td>
						</tr>
						{#each data as prop}
							<tr>
								<td class="py-3 pl-4 align-baseline sm:pl-0">
									<code class="!text-sm">{prop.label}</code>
								</td>
