...
<style lang="scss" global>
	...
	.mdsvex code.neutral {
		@apply bg-neutral-700/50 text-neutral-50;
	}
	...
	[data-rehype-pretty-code-fragment] [data-line-numbers] > [data-line]::before {
		@apply text-xs text-neutral-400/40;
	...
	[data-rehype-pretty-code-fragment] {
		...
		& [data-highlighted-line] {
			@apply border-l-magnum-300 bg-magnum-500/[0.1];
		}
	...
	[data-chars-id='ul'] {
		@apply '!font-bold' border-b border-b-magnum-500;
	}

	[data-chars-id='hi'] {
		@apply '!font-bold' rounded bg-magnum-500/[0.1] p-1;
	}

	[data-chars-id='r'] {
		@apply '!font-bold' border-b-magnum-600;
	}
