(() => {
	...
	var Le;
	function se(n, e) {
		return Le || (Le = document.createElement('a')), (Le.href = e), n === Le.href;
	}
	function zt(n) {
	...
	var Ut = typeof window < 'u' ? window : typeof globalThis < 'u' ? globalThis : global,
		_e = class {
			constructor(e) {
				(this.options = e), (this._listeners = 'WeakMap' in Ut ? new WeakMap() : void 0);
			}
			observe(e, t) {
				return (
	...
	function J(n, e, t, l, s, r, i, o = [-1]) {
		...
		if (
			...
			e.intro && D(n.$$.fragment), he(n, e.target, e.anchor, e.customElement), Wn(), Pt();
		}
		fe(a);
	}
	var tl;
	...
	function Ve(n, e = {}) {
		...
		if (nl.call(et, s)) {
			let o = et[s];
			return (e.normalize === void 0 || e.normalize === null || e.normalize) && typeof o == 'string'
				? Ve(o)
		...
		if (r > 1 && r < 9) {
			...
			for (
				s.charCodeAt(r) === 45 &&
					...
					s.charCodeAt(r) === 45 &&
						(z(s.charCodeAt(r + 1)) && z(s.charCodeAt(r + 2)) && !z(s.charCodeAt(r + 3))
				...
				for (; K(s.charCodeAt(a)); ) {
					if (a - o > 7) return i(a, 1, 'Too long variant, expected at most 8 characters');
					a++;
				}
				if (a - o > 4 || (a - o > 3 && Q(s.charCodeAt(o)))) t.variants.push(l.slice(o, a)), (r = a);
				else break;
			}
			for (
				;
				...
				for (; s.charCodeAt(o) === 45 && K(s.charCodeAt(o + 1)) && K(s.charCodeAt(o + 2)); ) {
					...
					for (o = h + 2, a++; K(s.charCodeAt(o)); ) {
						if (o - h > 7) return i(o, 2, 'Too long extension, expected at most 8 characters');
						o++;
					}
				}
				if (!a)
					return i(o, 4, 'Empty extension, extensions must have at least 2 characters of content');
				t.extensions.push({ singleton: l.charAt(r + 1), extensions: l.slice(r + 3, o).split('-') }),
					(r = o);
			}
		} else r = 0;
		if (
			...
			for (; s.charCodeAt(o) === 45 && K(s.charCodeAt(o + 1)); ) {
				...
				for (o = a; K(s.charCodeAt(o)); ) {
					if (o - a > 7) return i(o, 5, 'Too long private-use area, expected at most 8 characters');
					o++;
				}
	...
	function ll(n) {
		...
		return {
			...
			p(o, a) {
				o[0] ? i || ((i = Kt(o)), i.c(), i.m(e.parentNode, e)) : i && (i.d(1), (i = null));
			},
			d(o) {
				i && i.d(o), o && v(e), o && v(t);
			},
	...
	function Yt(n) {
		...
		return {
			c() {
				(e = C('div')), t && t.c(), p(e, 'class', 'pagefind-ui__result-thumb svelte-j9e30');
			},
			m(l, s) {
	...
	function rl(n) {
		...
		return {
			...
			p(r, [i]) {
				l === (l = t(r, i)) && s ? s.p(r, i) : (s.d(1), (s = l(r)), s && (s.c(), s.m(e, null)));
			},
			i: j,
			o: j,
			d(r) {
	...
	var tt = class extends q {
			constructor(e) {
				super(), J(this, e, il, rl, V, { show_images: 0, process_result: 4, result: 5 });
			}
		},
		$t = tt;
	function en(n, e, t) {
	...
	function ol(n) {
		...
		return {
			...
			p(o, a) {
				o[0] ? i || ((i = nn(o)), i.c(), i.m(e.parentNode, e)) : i && (i.d(1), (i = null));
			},
			d(o) {
				i && i.d(o), o && v(e), o && v(t);
			},
		...
		return {
			...
			p(d, T) {
				if (
					...
					d[4] ? (c ? c.p(d, T) : ((c = rn(d)), c.c(), c.m(t, h))) : c && (c.d(1), (c = null)),
					T & 8)
				) {
					E = d[3];
					let R;
	...
	function ln(n) {
		...
		return {
			c() {
				(e = C('div')), t && t.c(), p(e, 'class', 'pagefind-ui__result-thumb svelte-4xnkmf');
			},
			m(l, s) {
				y(l, e, s), t && t.m(e, null);
			},
	...
	function rn(n) {
		...
		return {
			c() {
				(e = C('p')), p(e, 'class', 'pagefind-ui__result-excerpt svelte-4xnkmf');
			},
			m(l, s) {
	...
	function on(n) {
		...
		return {
			...
			m(_, f) {
				y(_, e, f), b(e, t), b(t, l), b(l, r), b(e, o), b(e, a), (a.innerHTML = h);
			},
			p(_, f) {
	...
	function ul(n) {
		...
		return {
			c() {
				(e = C('li')), s.c(), p(e, 'class', 'pagefind-ui__result svelte-4xnkmf');
			},
			m(r, i) {
				y(r, e, i), s.m(e, null);
			},
	...
	var nt = class extends q {
			constructor(e) {
				super(), J(this, e, cl, ul, V, { show_images: 0, process_result: 6, result: 7 });
			}
		},
		fn = nt;
	function _n(n, e, t) {
	...
	function hn(n) {
		...
		return {
			...
			p(a, h) {
				if ((h & 56 && l !== (l = a[3]('filters_label', a[4], a[5]) + '') && N(s, l), h & 71)) {
		...
		return {
			...
			p(k, F) {
				(n = k),
					...
					F & 2 && r !== (r = n[13]) && ((t.__value = r), (t.value = t.__value)),
	...
	function gn(n) {
		...
		return {
			...
			p(c, E) {
				if (
					(E & 2 && l !== (l = c[9].replace(/^(\w)/, En) + '') && (t.innerHTML = l),
			...
			le.push(() => Gt(e, 'selected_filters', s)),
			{
				...
				p(i, o) {
					...
					o[0] & 16 && (a.show_empty_filters = i[4]),
						...
						!t && o[0] & 128 && ((t = !0), (a.selected_filters = i[7]), Lt(() => (t = !1))),
						e.$set(a);
				},
				i(i) {
	...
	function yn(n) {
		...
		return (
			...
			{
				c() {
					(e = C('div')), l.c(), p(e, 'class', 'pagefind-ui__results-area svelte-1d60ae3');
				},
				m(a, h) {
	...
	function Sr(n) {
		...
		return {
			...
			p(l, s) {
				s[0] & 147488 &&
					e !== (e = l[18]('zero_results', l[17], l[5]).replace(/\[SEARCH_TERM\]/, l[14]) + '') &&
					N(t, e);
			},
			d(l) {
				l && v(t);
	...
	function wr(n) {
		let e, t;
		return (
			(e = new $t({ props: { show_images: n[1], process_result: n[3], result: n[47] } })),
			{
				c() {
					Ge(e.$$.fragment);
				},
	...
	function Ar(n) {
		let e, t;
		return (
			(e = new fn({ props: { show_images: n[1], process_result: n[3], result: n[47] } })),
			{
				c() {
					Ge(e.$$.fragment);
				},
	...
	function wn(n) {
		...
		return {
			c() {
				(e = C('p')), (l = w(t)), p(e, 'class', 'pagefind-ui__message svelte-1d60ae3');
			},
			m(s, r) {
				y(s, e, r), b(e, l);
			},
			p(s, r) {
				r[0] & 147488 &&
					t !== (t = s[18]('searching', s[17], s[5]).replace(/\[SEARCH_TERM\]/, s[14]) + '') &&
					N(l, t);
			},
			d(s) {
				s && v(e);
	...
	function Mr(n) {
		...
		return {
			...
			p(R, k) {
				(!E || (k[0] & 131104 && s !== (s = R[18]('placeholder', R[17], R[5])))) &&
					p(l, 'placeholder', s),
					...
					(!E || (k[0] & 131104 && c !== (c = R[18]('search_label', R[17], R[5])))) &&
						p(t, 'aria-label', c),
			...
			d(R) {
				R && v(e), n[30](null), n[31](null), d && d.d(), T && T.d(), (u = !1), G(m);
			},
		};
	}
	...
	function Hr(n, e, t) {
		...
		for (let g = 0; g < s.length; g++) l[s[g]] = { language: s[g], ...Rn[g].strings };
...
`)
			...
			Fn = async () => {
				k && ((Ht = await k.filters()), (!ue || !Object.keys(ue).length) && t(16, (ue = Ht)));
			},
			Hn = (g) => {
				let H = {};
				return (
			...
			On = async (g, H) => {
				...
				Mt === O &&
					(P.filters && Object.keys(P.filters)?.length && t(16, (ue = P.filters)),
					t(11, (L = P)),
					t(12, (U = !1)),
					t(15, (Je = 5)));
			},
			...
			zn = (g) => {
				g.key === 'Escape' && (t(6, (R = '')), F.blur()), g.key === 'Enter' && g.preventDefault();
			};
		function Un() {
